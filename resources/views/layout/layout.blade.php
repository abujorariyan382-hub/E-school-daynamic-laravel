    ...
    <form class="d-flex" role="search">
     ...
     <div class="sideber">
      <nav class="nav flex-column" >
        <a class="nav-link" href="{{ route('dashboard.main.page') }}">
          <span class="icon">
        ...
        <div class="sub-menu collapse" id="submenu">
          <a class="nav-link " href="" >
             <nav class="sb-sidenav-menu-nested nav d-block mb-2 ">
              <a class="nav-link" href="{{ route('main.page') }}">Static Create</a>
          ...
          <span class="description"> Online  <i class="bi bi-caret-down-fill"></i>
        ...
        <div class="sub-menu collapse" id="submenu1">
          <a class="nav-link " href="" >
             <nav class="sb-sidenav-menu-nested nav d-block mb-2 ">
              <a class="nav-link" href="{{ route('online.page') }}">Static Create</a>
              <a class="nav-link" href="{{ route('list.page.online') }}">List</a>
              </nav>
          </a>
         </div>
         <!-- togel end -->
         ...
         <a class="nav-link " href="" data-bs-toggle="collapse" data-bs-target="#submenu2" aria-expanded="false">
          ...
          <span class="description"> Test  <i class="bi bi-caret-down-fill"></i>
        ...
        <div class="sub-menu collapse" id="submenu2">
          <a class="nav-link " href="" >
             <nav class="sb-sidenav-menu-nested nav d-block mb-2 ">
              <a class="nav-link" href="{{ route('test.page') }}">Static Create</a>
              <a class="nav-link" href="{{ route('list.page.test') }}">List</a>
              </nav>
          </a>
         </div>
         <!-- togel end -->
